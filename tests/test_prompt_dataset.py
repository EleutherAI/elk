from elk.extraction import load_prompts, ExtractionConfig
...
#             cfg.prompts.datasets[0], rank=0, world_size=1
#         )
...
#             returned_templates_ids = [
#               prompt.template.id for prompt in returned_prompts
#             ]
#
