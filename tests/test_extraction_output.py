...
class TestExtractionOutput:
    def testExtractionOutput(self):
        ...
        correct_output_file = pd.read_csv(
            "./test_data/deberta-v2-xxlarge-mnli_confusion_0.csv"
        )
        current_output_file = pd.read_csv(
            "../evaluation_results/deberta-v2-xxlarge-mnli_confusion_0.csv"
        )
