...
print(
    ...
    " tuple (state, label). state has shape (#data * #dim), and label has shape"
    " (#data).\n    permutation_dict: [train_idx, test_idx], where train_idx is the"
    " subset of [#data] that corresponds to the training set, and test_idx is the"
    " subset that corresponds to the test set.\n"
)
...
def getDic(
    ...
    permutation_dict = {
        set_name: getPermutation(data_dict[set_name]) for set_name in dataset_list
    }
...
print(
    ...
    " prompt_dict: Same as in getDir(). You can specify which prompt to get using this"
