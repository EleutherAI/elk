...
def get_args(default_config_path = "default_config.json"):
    ...
    parser.add_argument("--mode", type = str, default = "concat", choices = ["minus", "concat"], help = "How you combine h^+ and h^-.") 
    parser.add_argument("--save_dir", type = str, default = "evaluation_results", help = "where the csv and params are saved")
    parser.add_argument("--trained_models_path", type = str, default = "trained", help = "where to save the models trained via ccs and logistic regression")
