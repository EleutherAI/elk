...
from elk.utils_generation.load_utils import (create_setname_to_promptframe,
                                             get_num_templates_per_dataset,
                                             load_model, load_tokenizer,
                                             put_model_on_device)
from elk.utils_generation.parser import get_args
from elk.utils_generation.save_utils import (print_elapsed_time,
...
if __name__ == "__main__":
    ...
    print(
        f"Linish loading model to memory. Now start loading to accelerator (gpu or mps). parallelize = {args.parallelize is True}"
    )
    ...
    print(
        f"Loading tokenizer for: model name = {args.model} at cache_dir = {args.cache_dir}"
    )
