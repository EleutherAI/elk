...
def save_debug_log(datasets: list[DatasetDict], out_dir: Path, is_raw: bool) -> None:
    """
    ...
    if is_raw:
        ...
        text_input = next(iter(ds.values()))[0]["text_input"]
        logging.info(f"Example raw input: {text_input}")
    else:
        for ds in datasets:
            logging.info(
                "=========================================\n"
